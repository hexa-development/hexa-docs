...
ข้อควรรู้: `config/main.lua` ที่แถมมาตั้งไว้เป็น `'steam'` ถ้าอยากได้พฤติกรรมที่ปลอดภัยกว่า
...
คีย์นี้มีอยู่ใน `config/save.lua` แต่ไม่มีโค้ดจุดไหนอ่านมันเลย ตัวจัดการ `playerDropped` ใน

...
งานที่เกี่ยวกับกระเป๋าของถูกส่งต่อให้ `hexa_inventory` ทุกจุดที่ `hexa_core` เรียก export ของมัน
...
`.Functions` เป็นตารางจริงที่ถูกมิเรอร์ให้ตรงกับชั้นแบน ไม่ใช่ proxy เปล่า เพราะ bridge ของ RSG
